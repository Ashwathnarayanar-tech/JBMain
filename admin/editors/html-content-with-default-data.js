        ...
        case 'Jelly Belly Recipe':
            return 	    '<div class="bean-recipe-row">\n'+
                                ...
                                '<ul>\n'+
                                    '<li>\n'+
                                        '<figure>\n'+
                                            '<img alt="Chocolate pudding recipe" title="Chocolate Pudding" src="/resources/images/jb-beans-receipe/pudding.jpg">\n'+
                                        '</figure>\n'+
                                        '<p>\n'+
                                    ...
                                    '<li class="bg-none">\n'+
                                        '<figure>\n'+
                                            '<img alt="Buttered Popcorn recipe" title="Buttered Popcorn" src="/resources/images/jb-beans-receipe/popcorn.jpg">\n'+
                                        '</figure>\n'+
                                        '<p>\n'+
                                    ...
                                    '<li class="result">\n'+
                                        '<figure>\n'+
                                            '<img alt="Generic recipe graphic" title="" src="/resources/images/jb-beans-receipe/output9.png">\n'+
                                        '</figure>\n'+
                                        '<p></p>\n'+
                                    '</li>\n'+
                                '</ul>\n'+
        ...
        case 'Image Category Listing':
            return 	    '<div class="category-listing-block">\n'+
                            '<div class="category-image-block">\n'+
                                '<figure>\n'+
                                    '<img alt="Beanboozled graphic" src="/resources/images/explore/beanboozled/beanboozled1.jpg" title="Lime">\n'+
                                '</figure>\n'+
                                '<p>\n'+
                            ...
                            '<div class="category-image-block">\n'+
                                '<figure>\n'+
                                    '<img alt="Beanboozled graphic" src="/resources/images/explore/beanboozled/beanboozled3.jpg" title="Barf">\n'+
                                '</figure>\n'+
                                '<p>\n'+
