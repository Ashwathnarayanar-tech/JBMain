...
$(function () {
	...
	$('#fullvideo').click(function () {
		$('.holdervideo').fadeIn();
		setTimeout(function(){
			$(document).find('#closevideo').focus();
		},500);
	});

	$(document).on('keypress', '#fullvideo', function (e) {
			$('#fullvideo').trigger('click');
	});

	$('#closevideo').click(function () {
		$('.holdervideo').fadeOut();
		$(document).find('#fullvideo').focus();
	});

	$(document).on('keypress', '#closevideo', function (e) {
		...
		var tm = setInterval(function () {
				...
				if (iter <= 0) {
					...
					if (degree >= 127 && degree <= 162) {
						...
						$('h3 p').html('Will it be Tutti-Fruitti or Stinky Socks?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						$('#video_frame').attr('title', 'Video for Will it be Tutti-Fruitti or Stinky Socks?');
						if (vid1sec % 2 === 0) {
						...
						$('h3 p').html('Will it be Lime or Lawn Clippings?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						$('#video_frame').attr('title', 'Video for Will it be Lime or Lawn Clippings?');
						if (vid2sec % 2 === 0) {
						...
						$('h3 p').html('Will it be Toothpaste or Berry Blue?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						$('#video_frame').attr('title', 'Video for Will it be Toothpaste or Berry Blue?');
						if (vid3sec % 2 === 0) {
							$('#popvideo').attr('src', 'https://www.youtube.com/embed/Hq_Jt4YxI90?rel=0&enablejsapi=1&html5=1');
							videoval = "Video5 Value1"
								if (navigator.userAgent.match(/Android/i)) {
						...
						$('h3 p').html('Will it be Buttered Popcorn or Rotten Egg?');
						$('#video_frame').attr('title', 'Video for Will it be Buttered Popcorn or Rotten Egg?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						if (vid4sec % 2 === 0) {
							$('#popvideo').attr('src', 'https://www.youtube.com/embed/B2I2o9xC0AM?rel=0&enablejsapi=1&html5=1');
							videoval = "Video6 Value1"
						...
						$('h3 p').html('Will it be Chocolate Pudding or Canned Dog Food?');
						$('#video_frame').attr('title', 'Video for Will it be Chocolate Putting or Canned Dog Food?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						if (vid5sec % 2 === 0) {
							$('#popvideo').attr('src', 'https://www.youtube.com/embed/B2I2o9xC0AM?rel=0&enablejsapi=1&html5=1');
							videoval = "Video7 Value1"
						...
						$('h3 p').html('Will it be Barf or Peach?');
						$('#video_frame').attr('title', 'Video for Will it be Barf or Peach?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						if (vid6sec % 2 === 0) {
						...
						$('h3 p').html('Will it be Moldy Cheese or Caramel Corn?');
						$('#video_frame').attr('title', 'Video for Will it be Moldy Cheese or Caramel Corn?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						if (vid7sec % 2 === 0) {
						...
						$('h3 p').html('Will it be Booger or Juicy Pear?');
						$('#video_frame').attr('title', 'Video for Will it be Booger or Juicy Pear?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						if (vid8sec % 2 === 0) {
							$('#popvideo').attr('src', 'https://www.youtube.com/embed/g4fPqmijKXU?rel=0&enablejsapi=1&html5=1');
							videoval = "Video10 Value1"
						...
						$('h3 p').html('Will it be Spoiled Milk or Coconut?');
						$('#video_frame').attr('title', 'Video for Will it be Spoiled Milk or Coconut?');					
							// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						 if (vid10sec % 2 === 0) {
						...
						$('.jelly_selectors ul li img.highlight,.jelly_selectors ul li img.highlight2').remove();
						$('.jelly_selectors ul li:nth-child(1)').append('<img class="highlight" src="//content.jellybelly.com/beanboozled/images/shadow.png" alt=""><img class="highlight2" src="//content.jellybelly.com/beanboozled/images/shadow.png" alt="">');
					} else if ((degree >= 0 && degree <= 18) || (degree >= 342 && degree <= 360)) {
						vid10sec += 1;
						$('#soundeff').get(0).pause();
						//console.log('value 4');
						//$('h3 a').attr('rel','http://www.youtube.com/embed/XD_rdLfGQC4?rel=0&enablejsapi=1&html5=1');
						videoval = "Video2 Value1";
						$('h3 p').html('Will it be Dead Fish or Strawberry Banana Smoothie?');
						$('#video_frame').attr('title', 'Video for Will it be Dead Fish or Strawberry Banana Smoothie?');
						// sessionStorage.setItem('selector',Math.floor((Math.random() * 2) + 1));
						 if (vid10sec % 2 === 0) {
							$('#popvideo').attr('src', 'https://www.youtube.com/embed/O0cFbBqZY0w?rel=0&enablejsapi=1&html5=1');
							videoval = "Video2 Value1"
						...
						$('h3 img').attr('src', '//content.jellybelly.com/beanboozled/images/jelly11.png');
						$('.jelly_selectors ul li img.highlight,.jelly_selectors ul li img.highlight2').remove();
						$('.jelly_selectors ul li:nth-child(2)').append('<img class="highlight" src="//content.jellybelly.com/beanboozled/images/shadow.png" alt=""><img class="highlight2" src="//content.jellybelly.com/beanboozled/images/shadow.png" alt="">');
					}
					clearInterval(tm);
