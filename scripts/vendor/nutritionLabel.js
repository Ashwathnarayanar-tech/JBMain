...
;(function($) { // eslint-disable-line no-extra-semi
	...
	function addScrollToItemDiv($localElem, $localSettings, localNameClass, forLegacyLabel) {
		var local_scrollLongItemNamePixel = parseInt($localSettings.scrollLongItemNamePixel);
		if (!forLegacyLabel) {
	...
	function sevingUnitQuantityHtmlLegacy($localSettings) {
		var localServingSizeIsHidden = false;
		var localServingContainerIsHidden = false;
		var localNutritionLabel = '';
	...
	function calorieDietHtmlLegacy($localSettings) {
		var localNutritionLabel = globalTab2 + '<table class="tblCalorieDiet" aria-hidden="true">\n';
	...
	function disclaimerHtmlLegacy($localSettings) {
		var localNutritionLabel = globalTab3 + '<br/>\n\n';
	...
	function bottomLinkHtmlLegacy($localSettings) {
		var localNutritionLabel = globalTab1 + '<div class="spaceAbove"></div>\n';
	...
	function generateAttributeWithoutPercentageHtmlLegacy(
		...
		var localNaValue = '<font class="notApplicable" aria-hidden="true">' + $localSettings.textNotApplicable + '&nbsp;</font><font class="sr-only">' +
	...
	function generateAttributeWithPercentageHtmlLegacy(
		...
		var localNutritionLabel = globalTab1 + '<div class="' + lineClass + '" tabindex="0">\n';
	...
	function generateAttributeHtml2018Version(
		...
		var localNaValue = '<font class="notApplicable" aria-hidden="true">' + $localSettings.textNotApplicable + '&nbsp;</font><font class="sr-only">' +
			$localSettings.textDataNotAvailable + '</font>\n';
		var localNutritionLabel = globalTab1 + '<div class="' + topDivClass + '" tabindex="0">\n';
	...
	function bottomLinkHtml2018Version($localSettings) {
		var localNutritionLabel = globalTab1 + '<div class="nf-spaceAbove"></div>\n';
	...
	function generateAttributeForUK(
		...
		var localNaValue = '<font class="notApplicable" aria-hidden="true">' + $localSettings.textNotApplicable + '&nbsp;</font><font class="sr-only">' +
			$localSettings.textDataNotAvailable + '</font>\n';
		var localNutritionLabel = globalTab2 + '<tr tabindex="0">\n';
		var nameClass = '';
	...
	function referenceIntakeHtmlUKVersion($localSettings) {
		var localNutritionLabel = globalTab6 + '<div class="referenceIntake" tabindex="0">\n';
	...
	function ingredientsHtmlUKVersion($localSettings) {
		var localNutritionLabel = globalTab6 + '<div class="uk_nf-ingredientListDiv" tabindex="0">\n';
	...
	function disclaimerHtmlUKVersion($localSettings) {
		var localNutritionLabel = globalTab6 + '<div id="uk_nf-calcDisclaimer">\n';
	...
	function bottomLinkHtmlUKVersion($localSettings) {
		var localNutritionLabel = globalTab6 + '<div class="uk_nf-spaceAbove"></div>\n';
	 ...
	 * // => 4100
	 */
	var roundLoDash = createRound('round');
	...
	NutritionLabel.prototype = {
		generateLegacy: function() {
			...
			var useLine = 'addedPadding';
			var useLineAgain = 'addedPadding';
		...
		generate2018: function() {
			...
			if ($this.settings.showVitaminD || $this.settings.showCalcium || $this.settings.showIron || $this.settings.showPotassium_2018) {
				var lastRowNutrition = 'valueVitaminD';
				var firstRowNutrition = 'valuePotassium_2018';
				...
				if ($this.settings.showCaffeine) {
					var labelClassCaffeine = 'nf-highlight';
