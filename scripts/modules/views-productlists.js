            ...
            cornerLabel:function(c){    
                ...
                for(var i=0; i<products.length; i++){
                   ...
                   // var currentDate = date.getDate().toString()+'-'+date.getMonth().toString()+'-'+date.getFullYear().toString();
                    ...
                    if(days <= Hypr.getThemeSetting('newLabelThreshold') && days >= 0){
            ...
            Backbone.MozuView.prototype.render.apply(this);
                if(e){
                    _.each(e.facets,function(data){
                        ...
                        _.each(data.values,function(final){
                            var isapplied=JSON.stringify(final.isApplied);
                            var temp=JSON.stringify(final.value);
