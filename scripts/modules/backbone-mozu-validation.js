    ...
    Backbone.Validation = (function (_) {
        ...
        var defaultCallbacks = Validation.callbacks = {
            ...
            valid: function (view, attr) {
                ...
                jQuery(document).find('[data-mz-value="' + attr + '"]').filter(':visible').removeClass('is-invalid');
                jQuery(document).find('[data-mz-validationmessage-for="' + attr + '"]').text(''); 
            },
            ...
            invalid: function (view, attr, error) {
                ...
                jQuery(document).find('[data-mz-value="' + attr + '"]').filter(':visible').addClass('is-invalid');
                jQuery(document).find('[data-mz-validationmessage-for="' + attr + '"]').text(error);
            }
        };
