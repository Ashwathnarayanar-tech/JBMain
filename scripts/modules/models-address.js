    ...
    function(Backbone, Hypr) {
        ...
        var PhoneNumbers = Backbone.MozuModel.extend({
            validation: {
                home: {
                    required: true,
                    msg: Hypr.getThemeSetting("phoneMissing")
                }
            }
        }),
        ...
        StreetAddress = Backbone.MozuModel.extend({
            ...
            validation: {
                address1: {
                    required: true,
                    msg: Hypr.getThemeSetting("streetMissing")
                },
                cityOrTown: {
                    required: true,
                    msg: Hypr.getThemeSetting("cityMissing")
                },
                countryCode: {
                    required: true,
                    msg: Hypr.getThemeSetting("countryMissing")
                },
                stateOrProvince: {
                    required: true,
                    msg: Hypr.getThemeSetting("stateProvMissing")
                },
                postalOrZipCode: {
                    required: true,
                    msg: Hypr.getThemeSetting("postalCodeMissing")
                }
            },
