define(['jquery', 'underscore', 'modules/backbone-mozu', 'hyprlive'], 
    function ($, _, Backbone, Hypr) {
    ...
    var CreditCard = PaymentMethod.extend({
        ...
        validation: {
            paymentOrCardType: {
                fn: "present",
                msg: Hypr.getThemeSetting('cardType')
            },
            cardNumberPartOrMask: {
                fn: "present",
                msg: Hypr.getThemeSetting('cardNumber')
            },
            expireMonth: {
            ...
            nameOnCard: {
                fn: "present",
                msg: Hypr.getThemeSetting('nameOnCard')
            }
        },
        initialize: function () {
            var self = this;
