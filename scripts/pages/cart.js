       ...
       /* testfun: function(e) {
        ...
        render:function(){
            var total=this.model.apiModel.data.discountedTotal;
             if(total<Hypr.getThemeSetting('freeshippingBoundingValue')){
                var amt=(Hypr.getThemeSetting('freeshippingBoundingValue')-parseFloat(total,10)).toFixed(2);
               this.model.attributes.remainingfreeshippinng=amt;
            }else{
...
/*        estimateShip: function(e) {
    ...
    function notifymedilog(){
        ...
        $(document).on('mouseenter','.discount',function(){
            $(this).addClass('border-show').removeClass('border-hide');
            if($(this).prev().hasClass('error-msg')){
                $(this).prev().prev().addClass('border-show').removeClass('border-hide');
            }
            $(this).prev().addClass('border-show').removeClass('border-hide');
        });
        
        $(document).on('mouseleave','.discount',function(){
           $(this).addClass('border-hide').removeClass('border-show');
            if($(this).prev().hasClass('error-msg')){
                $(this).prev().prev().addClass('border-hide').removeClass('border-show'); 
            }
            $(this).prev().addClass('border-hide').removeClass('border-show'); 
        });
        
        $(document).on('mouseenter','.mz-carttable-item',function(){
           $(this).addClass('border-show').removeClass('border-hide');
            if($(this).next().hasClass('error-msg')){
                $(this).next().next().addClass('border-show').removeClass('border-hide');
            }
            $(this).next().addClass('border-show').removeClass('border-hide');
        });
        
        $(document).on('mouseleave','.mz-carttable-item',function(){
            $(this).addClass('border-hide').removeClass('border-show');
            if($(this).next().hasClass('error-msg')){
                $(this).next().next().addClass('border-hide').removeClass('border-show'); 
            }
            $(this).next().addClass('border-hide').removeClass('border-show');  
        });
        
        $(document).on('mouseenter','.error-msg',function(){
            $(this).addClass('border-show').removeClass('border-hide');
            $(this).next().addClass('border-show').removeClass('border-hide');
            $(this).prev().addClass('border-show').removeClass('border-hide');
        });
        
        $(document).on('mouseleave','.error-msg',function(){
            $(this).addClass('border-hide').removeClass('border-show');
            $(this).next().addClass('border-hide').removeClass('border-show');
            $(this).prev().addClass('border-hide').removeClass('border-show'); 
        });
