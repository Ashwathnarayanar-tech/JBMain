...
*/	
    ...
    tealium.prototype = {
        ...
        pageTypeGoogleDynamicRemarketing: function() { // Check Page Type
            console.log("checking GDR");
            if (!this.urlCheck1)
                return 'home';
            else if (this.urlCheck2 === 'c' || this.urlCheck3 === 'c')
                return 'category';
            else if (this.urlCheck3 === 'p')
                return 'product';
            else if (this.urlCheck1 === 'search')
                ...
                return 'other';
            else if (this.urlCheck1 == 'cart') {
                console.log("GDR cart");
                return 'cart';
            } else if (this.urlCheck1 == "shopmain" || this.urlCheck1 == "shopmain")
                return 'other';
            else if (this.urlCheck1 == "ourcandy" || this.urlCheck1 == "visitjellybelly" || this.urlCheck1 == "funstuff" || this.urlCheck1 == "sportssponsorships" || this.urlCheck1 == "gift-cards" || this.urlCheck1 == "storelocator")
        ...
        myTimer: function(that, myVar) {
            ...
            if (CartId !== "") {
                ...
                utag_data = {
                    ...
                    page_type_googleDynamicRemarketing: that.pageTypeGoogleDynamicRemarketing(),
                    page_section_name: "",
                    page_category_name: "",
        ...
        myCategory: function(thats, myVar) {
            ...
            if (CartId !== "") {
                ...
                utag_data = {
                    ...
                    page_type_googleDynamicRemarketing: thats.pageTypeGoogleDynamicRemarketing(),
        ...
        buildTag: function(type, options) { // Build Utag_data based on Page type
            if (type == "cart") { // Cart Page   
                ...
                utag_data = {
                    ...
                    page_type_googleDynamicRemarketing: this.pageTypeGoogleDynamicRemarketing(),
                    page_referring_url: document.referrer,
			...
			confimg1.src = "//content.jellybelly.com/pixel/pixel.aspx?order_id=TBD&step=BUILDING_CONF_UTAG";
				...
				var confimg2;
				confimg2 = document.createElement('img');
				confimg2.src = "//content.jellybelly.com/pixel/pixel.aspx?order_id=" + utag_data.order_id + "&step=UTAG_BUILT";

                var cookieString = 'confirmationSeen' + this.confirmationDetail('order_id').toString();
                if ($.cookie(cookieString)) {
                    // do nothing, we've already set this cookie
                } else {
                    // set a cookie now that we have seen this confirmation
                    $.cookie(cookieString, true);
                    this.loadScript();
                }
            }
            return true;
        ...
        loadScript: function() { // Build Tealium Tag
            ...
            var env = 'dev';
            if ((window.location.href.indexOf('jellybelly.com') > -1) || (window.location.href.indexOf('t9046-s11441') > -1)) {
				env = 'prod';
                }
            else if (window.location.href.indexOf('t10569-s13532') > -1) {
				env = 'qa';
            }
            else {
                env = 'dev';
            }
			console.log("tealium: " + env);
            (function(a,b,c,d){a='//tags.tiqcdn.com/utag/jellybelly/tlc-access/'+ env + '/utag.js';b=document;c='script';d=b.createElement(c);d.src=a;d.type='text/java'+c;d.async=true;a=b.getElementsByTagName(c)[0];a.parentNode.insertBefore(d,a); /* console.log(a); console.log(b); console.log(c); console.log(d); */ })();
			
/*			var gaimg1;
			gaimg1 = document.createElement('img');
			gaimg1.src = "//content.jellybelly.com/pixel/pixel.aspx?order_id="+ utag_data.order_id + "&step=SENT_GA";
*/
